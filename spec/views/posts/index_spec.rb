...
RSpec.describe 'Post index page', type: :feature do
  before(:each) do
    ...
    @post.comments.create! text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit', author_id: @user.id
    @post.comments.create! text: 'Consectetur adipiscing elit', author_id: @user.id
  ...
  it "I can see some of the post's body." do
    expect(page).to have_content('Lorem ipsum amet1')
    expect(page).to have_content('Lorem ipsum amet2')
  end
